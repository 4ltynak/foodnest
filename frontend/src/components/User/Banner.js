...
function Banner(){
    ...
    return(
        ...
        sx={{width: "100%", backgroundImage: "url(/img/banner-img.jpg)", backgroundSize: "cover", alignItems: "center"}}>
            <Grid size={12}>
                <Typography variant="h1" color="white" Typography variant="h1" color="white" sx={{fontSize: {xs: "2.5rem"}}} alignSelf={"center"}>FOODNEST</Typography>
            </Grid>
            <Grid size={12}>
                <Typography variant="h2" color="white" sx={{fontSize: {xs: "1.5rem"}}}>Where great food meets great places.</Typography>
            <Grid size={12}>
