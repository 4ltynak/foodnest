...
This project was created using React Native with MaterialUI for UI/UX, while also using ImgBB API for image file hosting. This project also includes a mock backend server during development which was created using JSON Server to simulate calls to a server. 
